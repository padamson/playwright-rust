---
description: Use this workflow when implementing new Playwright API features using strict TDD workflow. Automates Red→Green→Refactor cycle, cross-browser testing, and API compatibility validation.
---
...
2. **Reference playwright-python implementation**:
   - Use `read_url_content` to check https://github.com/microsoft/playwright-python
