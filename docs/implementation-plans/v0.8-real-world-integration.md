...
- [x] **Route API Review**: Verify `route.continue_()` overrides and `route.fulfill()` behavior (recorded then as a known limitation, body not sent; superseded 2026-09-05: it was the crate's wire format, fixed after 0.17.0)
